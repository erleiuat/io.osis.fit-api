...
class Food {
  ...
  public function set($arr) {
    ...
    $this->total_carbs = $arr["total_carbs"];
  ...
  public static function formResponse($arr) {
    ...
    return (object) [
      ...
      "title" => $arr['title'],
      "totalCalories" => (float) $arr['total_calories'],
      "totalFat" => (float) $arr['total_fat'],
      "totalProtein" => (float) $arr['total_protein'],
      "totalCarbs" => (float) $arr['total_carbs'],
      "portionSize" => (float) $arr['portion_size'],
      "date" => $date,
      "time" => $time
    ];
  }
