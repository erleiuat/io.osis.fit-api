...
class Template_Edit extends Template_Read {
    ...
    public function edit() {
        ...
        Database::bind($stmt, 
            ['a_template_id', 'account_id', 'image', 'title', 'calories_per_100', 'fat_per_100', 'protein_per_100', 'portion_size'], 
            [$this->a_template_id, $this->account_id, $this->image, $this->title, $this->calories_per_100, $this->fat_per_100, $this->protein_per_100, $this->portion_size]
        );
